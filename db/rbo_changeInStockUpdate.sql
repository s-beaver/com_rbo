...
UPDATE rbo_products SET product_in_stock = ifnull(product_in_stock,0) - @signMoveVar * ifnull(OLD.product_cnt, 0) * ifnull(product_type, 0) WHERE productId = OLD.productId;
...
UPDATE rbo_products SET product_in_stock = ifnull(product_in_stock,0) + @signMoveVar * ifnull(NEW.product_cnt, 0) * ifnull(product_type, 0) WHERE productId = NEW.productId;
