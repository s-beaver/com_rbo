...
class RbOInvoice {
	...
	public function invRead() {
		$q = "SELECT inv_num, inv_date, inv_cust, inv_sum, inv_status, inv_rem, " . "inv_firm, inv_manager, created_by, created_on, modified_by, modified_on " . "FROM rbo_invoices WHERE invId=" . $this->invId;
		...
		$q = "SELECT product_code, product_name, product_cnt, product_price, product_cnt*product_price FROM rbo_invoices_products WHERE inv_num=" . $inv ["inv_num"];
		$this->db->setQuery ( $q );
	...
	public function invUpdate() {
		/*
		 * $phStatus="";
		 * if ($this->inv_status!="") $phStatus = ",
		 * phStatus='".$this->inv_status."' ";
