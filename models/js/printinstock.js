...
function fillReport(rep_data) {
    ...
    var report = "", totals = 0, rowTotal, product_code, product_name, product_in_stock, product_price;
    report = "<thead>";
    report += "<td>Код</td>";
    ...
    for (var i = 0; i < prd.length; i++) {
        ...
        rowTotal = product_in_stock * product_price;
        report += "<tr>";
        report += "<td>" + product_code + "</td>";
        report += "<td>" + product_name + "</td>";
        report += "<td align='center'>" + product_in_stock + "</td>";
