    ...
    <form id="cst-form-form" method="post" action="">
        ...
        <fieldset style='padding: 0'>
            ...
            <table>
                ...
                <tr>
                    <td colspan="2"><label for="rbo_cust.cust_nonds">Без НДС</label><input type="checkbox"
                                                                                           name="rbo_cust.cust_nonds"
                                                                                           id="rbo_cust.cust_nonds">
            ...
            <table>
                <tr>
                    <td colspan="2"><label for="rbo_cust.cust_inn">&nbsp;ИНН</label><input type="text"
                                                                                           name="rbo_cust.cust_inn"
                                                                                           id="rbo_cust.cust_inn"
                                                                                           style='width: 150px'/> <label
                            for="rbo_cust.cust_kpp">&nbsp;КПП</label><input
                            type="text" name="rbo_cust.cust_kpp" id="rbo_cust.cust_kpp" style='width: 150px'/></td>
                </tr>
                <tr>
                    <td colspan="2"><label for="rbo_cust.cust_okpo">ОКПО</label><input type="text"
                                                                                       name="rbo_cust.cust_okpo"
                                                                                       id="rbo_cust.cust_okpo"
                                                                                       style='width: 150px'/> <label
                            for="rbo_cust.cust_ogrn">&nbsp;ОГРН</label>
                ...
                <tr>
                    <td colspan="2"><label for="rbo_cust.cust_rch">р/сч</label><input type="text"
                                                                                      name="rbo_cust.cust_rch"
                                                                                      id="rbo_cust.cust_rch"
                                                                                      style='width: 250px'/> <label
                            for="rbo_cust.cust_kch">к/сч</label><input
