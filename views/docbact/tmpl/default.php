    ...
    <form id="b_act.doc-form-form" method="post" action="">
        <fieldset style='padding: 0'>
            <table style='width: 100%'>
                <tr>
                    <td>
                        <div style="float: left">
                            ...
                            <input type="text" name="b_act.doc_num" id="b_act.doc_num"
                                   style='text-align: right; width: 50px'/>
                            <label for="b_act.doc_date">от</label>
                            <input type="text" name="b_act.doc_date" id="b_act.doc_date"
                                   style='text-align: center; width: 100px'/>
                        </div>
                        <div style="float: right">
                            <label for="b_act.doc_sum">Сумма</label>
                            <input disabled type="text" name="b_act.doc_sum" id="b_act.doc_sum"
                ...
                <tr>
                    <td><a href="" id="b_act.prod_add_btn"> <img
                        ...
                        <div style="float: right">
                            ...
                            <button id="b_act.cedit">..</button>
                            <label for="b_act.doc_firm">Фирма</label>
                ...
                <tr>
                    <td>
                        <div style="float: right">
                            <label for="b_act.doc_rem" style="vertical-align: top;">Прим.</label>
                            <textarea name="b_act.doc_rem" id="b_act.doc_rem"
