    ...
    <form id="cust-form-form" method="post" action="">
        <fieldset style='padding: 0'>
            <table>
                ...
                <tr>
                    <td colspan="2"><label for="cust_name">Название</label>&nbsp;<select name="cust_name" id="cust_name"
                                                                                         style="width: 400px"></select>
                        <label for="cust_is_own_firm">Своя компания</label><input type="checkbox"
                                                                                  name="cust_is_own_firm"
                                                                                  id="cust_is_own_firm"></td>
                </tr>
            </table>
            <table>
                <tr>
                ...
                <tr>
                    <td colspan="2"><label for="cust_nonds">Без НДС</label><input type="checkbox" name="cust_nonds"
                                                                                  id="cust_nonds"> <label
                            for="cust_phone">&nbsp;Тел.</label> <input
                            type="text" name="cust_phone" id="cust_phone" style='width: 200px'/> <label
                            for="cust_email">&nbsp;@</label> <input type="text" name="cust_email"
                                                                    id="cust_email" style='width: 200px'/></td>
                </tr>
            </table>
            <table>
                <tr>
                    <td colspan="2"><label for="cust_inn">&nbsp;ИНН</label><input type="text" name="cust_inn"
                                                                                  id="cust_inn" style='width: 150px'/>
                        <label for="cust_kpp">&nbsp;КПП</label><input
                            type="text" name="cust_kpp" id="cust_kpp" style='width: 150px'/></td>
                </tr>
                <tr>
                    <td colspan="2"><label for="cust_okpo">ОКПО</label><input type="text" name="cust_okpo"
                                                                              id="cust_okpo" style='width: 150px'/>
                        <label for="cust_ogrn">&nbsp;ОГРН</label>
                ...
                <tr>
                    <td colspan="2"><label for="cust_rch">р/сч</label><input type="text" name="cust_rch" id="cust_rch"
                                                                             style='width: 250px'/> <label
                            for="cust_kch">к/сч</label><input
                            type="text" name="cust_kch" id="cust_kch" style='width: 250px'/></td>
                </tr>
                <tr>
                    <td colspan="2"><label for="cust_rem">Прим.</label>
                        <textarea name="cust_rem" id="cust_rem"
