    ...
    <form id="d_cmp.doc-d-cmp-form-form" method="post" action="">
        <fieldset style='padding: 0'>
            <table style='width: 100%'>
                <tr>
                    <td>
                        <div style="float: left">
                            ...
                            <input type="text" name="d_cmp.doc_num" id="d_cmp.doc_num"
                                   style='text-align: right; width: 50px'/>
                            <label for="d_cmp.doc_date">от</label>
                            <input type="text" name="d_cmp.doc_date" id="d_cmp.doc_date"
                                   style='text-align: center; width: 100px'/>
                        </div>
                        <div style="float: right">
                            <label for="d_cmp.doc_sum">Сумма</label>
                            <input disabled type="text" name="d_cmp.doc_sum" id="d_cmp.doc_sum"
                ...
                <tr>
                    <td><a href="" id="d_cmp.prod_add_btn"> <img
                                    src="<?php echo JRBO_PATH ?>/images/icon-32-new-on.png"/></a>
                        <div style="float: right">
                            <label for="product_to_decomplect">Товар</label>
                            <input disabled type="text" name="product_to_decomplect" id="product_to_decomplect"
                                   style='width: 550px'/>
                            <button id="d_cmp.pedit">..</button>
                            <label for="d_cmp.doc_firm">Фирма</label>
                ...
                <tr>
                    <td>
                        <div style="float: right">
                            <label for="d_cmp.doc_rem" style="vertical-align: top;">Прим.</label>
                            <textarea name="d_cmp.doc_rem" id="d_cmp.doc_rem"
