    ...
    <form id="s_act.doc-form-form" method="post" action="">
        <fieldset style='padding: 0'>
            <table style='width: 100%'>
                <tr>
                    <td>
                        <div style="float: left">
                            ...
                            <input type="text" name="s_act.doc_num" id="s_act.doc_num"
                                   style='text-align: right; width: 50px'/>
                            <label for="s_act.doc_date">от</label>
                            <input type="text" name="s_act.doc_date" id="s_act.doc_date"
                                   style='text-align: center; width: 100px'/>
                        </div>
                        <div style="float: right">
                            <label for="s_act.doc_sum">Сумма</label>
                            <input disabled type="text" name="s_act.doc_sum" id="s_act.doc_sum"
                ...
                <tr>
                    <td><a href="" id="s_act.prod_add_btn"> <img
                                    src="<?php echo JRBO_PATH ?>/images/icon-32-new-on.png"/></a>
                        <div style="float: right">
                            <label for="s_act.pay_date">Оплата</label>
                            <input type="text" name="s_act.pay_date" id="s_act.pay_date"
                                   style='text-align: center; width: 100px'/>
                            ...
                            <button id="s_act.cedit">..</button>
                            <label for="s_act.doc_firm">Фирма</label>
                ...
                <tr>
                    <td>
                        <div style="float: right">
                            <label for="s_act.doc_rem" style="vertical-align: top;">Прим.</label>
                            <textarea name="s_act.doc_rem" id="s_act.doc_rem"
