                ...
                <tr>
                    <td>
                        <div style="float: left">
                            ...
                            <input type="text" name="inv.doc_num" id="inv.doc_num"
                                   style='text-align: right; width: 50px'/>
                            <label for="inv.doc_date">от</label>
                            <input type="text" name="inv.doc_date" id="inv.doc_date"
                                   style='text-align: center; width: 100px'/>
                        </div>
                        <div style="float: right">
                            <label for="inv.doc_sum">Сумма</label>
                            <input disabled type="text" name="inv.doc_sum" id="inv.doc_sum"
