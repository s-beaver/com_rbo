...
<body>
  <a href="javascript:createInvoice()"> <img src="components/com_rbo/images/icon-32-new-on.png" /></a>
          ...
          <tr>
            <td>
              <div style="float: left">
                ...
                <input type="text" name="inv_num" id="inv_num" style='text-align: right; width: 50px' />
                <label for="inv_date">от</label>
                <input type="text" name="inv_date" id="inv_date" style='text-align: center; width: 100px' />
              </div>
              <div style="float: right">
                <label for="inv_sum">Сумма</label>
                <input disabled type="text" name="inv_sum" id="inv_sum" style='text-align: right; width: 70px' />
                <label for="inv_status">Статус</label>
                <select id="inv_status" name="inv_status" style="width: 120px">
                  <option value=""></option>
                ...
                <select id="inv_manager" name="inv_manager" style="width: 120px">
                  <option value=""></option>
          ...
          <tr>
            <td><a href="javascript:showProductForm()"> <img src="components/com_rbo/images/icon-32-new-on.png" /></a>
              <div style="float: right">
                ...
                <input disabled type="text" name="inv_cust" id="inv_cust" style='width: 450px' />
                <button id="cedit">..</button>
                <label for="inv_firm">Фирма</label>
                <select id="inv_firm" name="inv_firm" style="width: 70px">
