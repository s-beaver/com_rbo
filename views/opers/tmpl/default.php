        ...
        <table style='width: 100%'>
          <tr>
            <td>
              ...
              <div style="float: right">
                ...
                <input type="text" name="rbo_opers.pay_date" id="rbo_opers.pay_date" style='text-align: center; width: 100px' />
          ...
          <tr>
            <td>
              <table>
                <tr>
                  <td style='visibility:hidden;'><label for="prod_search">Поиск</label> <input type="text" name="prod_search" id="prod_search" style='width:350px' />
