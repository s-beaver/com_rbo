...
<div style="width: 100%">
    ...
    <div style="display: inline-block; vertical-align: top;">
        ...
        <h2>Справка</h2>
        <ul id="selectable">
            <li><a href='http://robik.ru/zakrytye-materialy/39-rabota-v-uchetnoj-sisteme-robika'>Описание
                    работы в учетной системе</a></li>
            <li><a href='http://robik.ru/zakrytye-materialy/40-tipovye-operatsii'>Описание типовых
                    операций</a></li>
        </ul> 
    </div>
</body>
